...
output1 = Dense(1, activation='relu')(drop4)
...
filepath = "".join([path, "k31_5_", date, "-", filename])
...
hist = model.fit(x_train, y_train, epochs=100, batch_size=64, verbose=1, validation_split=0.25)
end_time = time.time()
...
# CPU vs GPU
# Epoch 100/100
# 103/103 ━━━━━━━━━━━━━━━━━━━━ 0s 2ms/step - loss: 20425.5977 - val_loss: 20714.6484
# 69/69 ━━━━━━━━━━━━━━━━━━━━ 0s 714us/step - loss: 21195.1875
# loss :  21195.1875
# 걸린 시간 :  21.18 초
# 69/69 ━━━━━━━━━━━━━━━━━━━━ 0s 844us/step
# r2 :  0.3578563928604126
# mse :  21195.19140625
# rmse :  145.58568407041264
# Epoch 100/100
# 103/103 [==============================] - 0s 2ms/step - loss: 20796.7949 - val_loss: 20989.5273
# 69/69 [==============================] - 0s 799us/step - loss: 21017.9277
# loss :  21017.927734375
# 걸린 시간 :  22.12 초
# 69/69 [==============================] - 0s 700us/step
# r2 :  0.3632270097732544
# mse :  21017.923828125
# rmse :  144.97559735391678