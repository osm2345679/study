...
#3. 컴파일, 훈련
path = './_save/keras31/'
model = load_model(path + 'k31_3_0914_1350-0042-27.8100.keras')
...
# hist = model.fit(x_train, y_train, epochs=2000, batch_size=10, verbose=1, validation_split=0.25, callbacks=[es, mcp])
