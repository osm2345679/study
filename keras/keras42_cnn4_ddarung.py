...
# model.add(Dropout(0.2))
# model.add(Dense(1))
model.add(Conv2D(64, (2,1), input_shape=(3,3,1)))   # (24, 24, 64). input_shape에서 행 무시-열 우선. (60000,28,28,1) -> (28,28,1)
model.add(Dropout(0.2))
...
# Results
# Epoch 2128/190000
# 25/25 [==============================] - 0s 4ms/step - loss: 3151.3411 - val_loss: 2943.7097
# 9/9 [==============================] - 0s 2ms/step - loss: 3338.1091
# loss :  3338.109130859375
# 9/9 [==============================] - 0s 841us/step
# mse :  3338.1091546968105
# rmse :  57.77637194127726
# 걸린 시간 :  387.37 초