...
hist = model.fit(x_train, y_train, epochs=1000, batch_size=32, verbose=1, validation_split=0.25)
...
submission.to_csv(path + "submit/" + "submit_0907_1331.csv")
...
# # 
# Epoch 1000/1000
# 205/205 ━━━━━━━━━━━━━━━━━━━━ 0s 970us/step - loss: 23178.4121 - val_loss: 22935.1738
# 69/69 ━━━━━━━━━━━━━━━━━━━━ 0s 680us/step - loss: 22773.9785
# loss :  22773.978515625
# 69/69 ━━━━━━━━━━━━━━━━━━━━ 0s 849us/step
# r2 :  0.3100244998931885
# mse :  22773.9765625
# rmse :  150.91049189006046