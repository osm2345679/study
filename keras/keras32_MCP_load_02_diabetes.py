...
path = './_save/keras31/'
model = load_model(path + 'k31_2_0914_1434-0459-2546.3601.keras')
...
# hist = model.fit(x_train, y_train, epochs=2400, batch_size=256, verbose=1, validation_data=(x_val, y_val), callbacks=[es, mcp])
