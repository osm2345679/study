...
filepath = "".join([path, "k31_3_", date, "-", filename])
...
hist = model.fit(x_train, y_train, epochs=100, batch_size=10, verbose=1, validation_split=0.25)
end_time = time.time()
...
# Epoch 358/2000
# 31/31 ━━━━━━━━━━━━━━━━━━━━ 0s 2ms/step - loss: 32.5977 - val_loss: 31.1332
# 4/4 ━━━━━━━━━━━━━━━━━━━━ 0s 5ms/step - loss: 21.3590 
# loss :  21.358989715576172

# CPU vs GPU
# Epoch 100/100
# 31/31 ━━━━━━━━━━━━━━━━━━━━ 0s 2ms/step - loss: 48.7623 - val_loss: 35.3081
# 4/4 ━━━━━━━━━━━━━━━━━━━━ 0s 4ms/step - loss: 26.3969 
# loss :  26.396947860717773
# 걸린 시간 :  8.42 초
# Epoch 100/100
# 31/31 [==============================] - 0s 2ms/step - loss: 48.0559 - val_loss: 33.8365
# 4/4 [==============================] - 0s 1ms/step - loss: 23.8465
# loss :  23.846532821655273
# 걸린 시간 :  7.34 초