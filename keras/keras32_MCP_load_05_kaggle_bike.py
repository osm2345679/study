...
#3. 컴파일, 훈련
path = './_save/keras31/'
model = load_model(path + 'k31_5_0914-1404-0092-20850.1445.keras')
...
#     filepath = filepath
# )
# hist = model.fit(x_train, y_train, epochs=5000, batch_size=64, verbose=1, validation_split=0.25, callbacks=[es, mcp])
